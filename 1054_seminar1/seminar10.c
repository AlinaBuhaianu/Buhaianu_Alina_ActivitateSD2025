...
//		}
//	
//		if ((*radacina)->gradEchilibru == 2)  //avem dezechilibru in stanga
//		{
//			if ((*radacina)->stg->gradEchilibru == 1)  //facem rotire la dreapta ca e caz simplu
//			{
...
//			}
//		}
//			if ((*radacina)->gradEchilibru == -2)  //rotire la stanga
//			{
